/* scripts/app/data-invite.js — module split from former scripts/app.js (one IIFE, now dissolved to shared global scope). Invite-flow fixtures: COLLEGE_META, LEARNER_ROSTER, INVITED_FIXTURE, COLLEGE_GROUPS.
  ...
  /* ════════════════════════════════════════════════════════════════
     ...
     COUNSELORS       persona data for dev-panel switching
  ...
  var INVITED_FIXTURE = [
    ...
    { id:'84257', lastName:'Alexander', firstName:'Carter',    college:'Arizona State University',      group:'Math - Dual Enrollment Fall 2026',     term:'FALL 2026',   course:null,                     dateInvited:'Jun 21, 2026' },
    { id:'65870', lastName:'Alexander', firstName:'David',     college:'Arizona State University',      group:'Early College Academy 26-27',     term:'FALL 2026',   course:null,                     dateInvited:'Jun 19, 2026' },
    { id:'42325', lastName:'Allan',     firstName:'Gloria',    college:'Mesa Community College',        group:'Fall 2026 Cohort', term:'FALL 2026',   course:null,                     dateInvited:'Jun 17, 2026' },
    { id:'21956', lastName:'Allan',     firstName:'Samuel',    college:'Mesa Community College',        group:'English - Dual Enrollment Fall 2026',         term:'FALL 2026',   course:null,                     dateInvited:'Jun 15, 2026' },
    ...
    { id:'29847', lastName:'Bailey',    firstName:'Morgan',    college:'Arizona State University',      group:'Science - Dual Enrollment Fall 2026',        term:'FALL 2026',   course:null,                     dateInvited:'Jun 8, 2026' },
    ...
    { id:'47193', lastName:'Bennett',   firstName:'Alex',      college:'Mesa Community College',        group:'Engineering - Dual Enrollment Fall 2026',     term:'FALL 2026',   course:null,                     dateInvited:'Jun 3, 2026' },
    { id:'56284', lastName:'Brooks',    firstName:'Casey',     college:'Arizona State University',      group:'Math - Dual Enrollment Spring 2026',     term:'SPRING 2026', course:null,                     dateInvited:'May 30, 2026' },
    ...
    { id:'72048', lastName:'Carter',    firstName:'Jordan',    college:'Mesa Community College',        group:'Fall 2026 Cohort', term:'FALL 2026',   course:null,                     dateInvited:'May 23, 2026' },
  ];
  /* Combined exchange model spans multiple high schools — assign one per invited learner
     (deterministic rotation) so the High School column (body.show-hs) populates.
